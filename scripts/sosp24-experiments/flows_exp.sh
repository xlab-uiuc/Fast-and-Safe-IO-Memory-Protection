...
python3 report-tput-metrics.py flow5 tput,drops,acks,iommu
...
python3 report-tput-metrics.py flow10 tput,drops,acks,iommu
...
python3 report-tput-metrics.py flow20 tput,drops,acks,iommu
...
python3 report-tput-metrics.py flow40 tput,drops,acks,iommu
