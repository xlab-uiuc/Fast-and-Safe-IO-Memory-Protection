...
python3 report-tput-metrics.py ring_buffer-2048 tput,drops,acks,iommu
...
python3 report-tput-metrics.py ring_buffer-1024 tput,drops,acks,iommu
...
python3 report-tput-metrics.py ring_buffer-512 tput,drops,acks,iommu
...
python3 report-tput-metrics.py ring_buffer-256 tput,drops,acks,iommu
